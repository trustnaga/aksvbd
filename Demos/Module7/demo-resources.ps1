...
SendMessageToCI "kubectl set image deploy workload1-dep nginx=nginx:1.22" "Kubectl command:" "Command"
kubectl set image deploy workload1-dep nginx=nginx:1.22
kubectl set image deploy workload2-dep nginx=nginx:1.22
kubectl set image deploy workload3-dep nginx=nginx:1.22
kubectl set image deploy workload4-dep nginx=nginx:1.22
...
DisplayStep "Next Step - Update the images to force the Pods to be created"
SendMessageToCI "kubectl set image deploy workload1-dep nginx=nginx:1.23" "Kubectl command:" "Command"
kubectl set image deploy workload1-dep nginx=nginx:1.23
kubectl set image deploy workload2-dep nginx=nginx:1.23
kubectl set image deploy workload3-dep nginx=nginx:1.23
kubectl set image deploy workload4-dep nginx=nginx:1.23
